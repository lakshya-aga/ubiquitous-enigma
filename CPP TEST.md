...
Here are **Scott Meyers–style C++ interview questions**: language mechanics, object lifetimes, overload resolution, RAII, move semantics, templates, and concrete implementation tasks. These are aimed at someone who already knows STL and DSA.
...
* Why is move constructor `noexcept`?

* Should `get()` return `FILE*` or `const FILE*`?

* What invariant does the class maintain?
