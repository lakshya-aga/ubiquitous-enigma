...
In order to estimate this better we employ [[Shrinkage]] which treats covariance as sample covariance and estimates a population covariance from the given sample. This helps is to not over rely on the estimated covariance. A harder and more precise application comes from [[Copula]] that are specifically used to model this "tail dependence"
