Device to connect a computer/device to network

It can be configured to offload tasks and perform a variety of things:

- High resolution timestamp for accurate measurement of performance etc.
