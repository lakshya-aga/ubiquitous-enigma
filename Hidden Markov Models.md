...
So given an observations set O: We can maximise the probability by adjusting the trajectory. Naively, calculate the probability of seeing the given observations for all possible state trajectories and choose the maximising trajectory: P(O_1|S_1)*pi_1 * A_12 * P(O_2|S_2)...
---
